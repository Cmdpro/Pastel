...
public class AE2Entry extends EntryProvider {
    public static String ID = "ae2_entry";

    public AE2Entry(CategoryProvider parent) {
        super(parent);
    }
            ...
            .withCondition(this
                               ...
                               .and(
                                   BookModLoadedConditionModel
                                       .create()
                                       .withModId(PastelIntegrationPacks.AE2_ID), this
                                       .condition()
