...
public class PastelDeathMessages {
	public static void addTranslations(LanguageProvider provider) {
		...
		provider.add("death.attack.pastel_evisceration.item", "%2$s threw %1$s into the meat grinder (%3$s) . Only their eyeball came out ;^;");
		...
		provider.add("death.attack.pastel_incandescence.item", "%1$s used %3$s to help %2$s become a star in bright vermilion - more kindling for the flame!");
		provider.add("death.attack.pastel_incandescence.player", "%2$s helped %1$s become a star in bright vermilion - more kindling for the flame!");
		...
		provider.add("death.attack.pastel_midnight_solution.player", "%1$s was lost in Translation being chased by %2$s");
		...
		provider.add("death.attack.pastel_sleep.item", "%2$s used %3$s to send %1$s on, unto the bottomless sea, accepting of all that is and could be.");
		provider.add("death.attack.pastel_sleep.player", "%2$s sent %1$s on, unto the bottomless sea, accepting of all that is and could be.");
