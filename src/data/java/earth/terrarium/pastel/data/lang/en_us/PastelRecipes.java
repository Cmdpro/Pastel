...
public class PastelRecipes {
	public static void addTranslations(LanguageProvider provider) {
		...
		provider.add("recipe.pastel.spawner.lore.increased_max_nearby_entities", "Less sensitive to creatures in proximity");
		provider.add("recipe.pastel.spawner.lore.increased_required_player_range", "Longer active when the player is farther away.");
		provider.add("recipe.pastel.spawner.lore.increased_spawn_count", "Increased count of spawned creatures");
		provider.add("recipe.pastel.spirit_instiller.secret.germinated_jade_vine_crossbreeding.hint", "Crossbreed two plants");
