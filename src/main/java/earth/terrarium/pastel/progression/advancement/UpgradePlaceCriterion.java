    ...
    public record Conditions(
        ...
        public boolean matches(
            ...
            return (this.blockPredicate.isEmpty() || this.blockPredicate
                .get()
                .matches(world, pos))
                   && (this.countRange.isEmpty() || this.countRange
                .get()
                .matches(upgradeCount))
                   && (this.speedRange.isEmpty() || this.speedRange
                .get()
                .matches(upgradeModifiers.get(Upgradeable.UpgradeType.SPEED)))
                   && (this.experienceRange.isEmpty() || this.experienceRange
                .get()
                .matches(upgradeModifiers.get(Upgradeable.UpgradeType.EXPERIENCE)))
                   && (this.efficiencyRange.isEmpty() || this.efficiencyRange
                .get()
                .matches(upgradeModifiers.get(Upgradeable.UpgradeType.EFFICIENCY)))
                   && (this.yieldRange.isEmpty() || this.yieldRange
                .get()
                .matches(upgradeModifiers.get(Upgradeable.UpgradeType.YIELD)));
        }
    }
