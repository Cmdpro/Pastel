...
public class BlockFamilies {
    ...
    public static final BlockFamily BLACKSLAG_FAMILY = PastelModelHelper.registerBlockFamilyExceptBase(
        new BlockFamily.Builder(PastelBlocks.BLACKSLAG.get())
            ...
            .getFamily(), PastelTexturedModels.cubeBottomTopWall(b -> b, "", b -> b, "_top", b -> b, "_top", b -> b, "")
    );
    ...
    public static final BlockFamily PYRITE_TILE_FAMILY = PastelModelHelper.registerBlockFamilyExceptBase(
        new BlockFamily.Builder(PastelBlocks.PYRITE_TILES.get())
            .stairs(PastelBlocks.PYRITE_TILES_STAIRS.get())
    ...
    public static final BlockFamily LIGHT_BLUE_COLORED_PLANKS_FAMILY = PastelModelHelper.registerBlockFamily(
        new BlockFamily.Builder(PastelBlocks.LIGHT_BLUE_PLANKS.get())
            .stairs(PastelBlocks.LIGHT_BLUE_STAIRS.get())
            .pressurePlate(PastelBlocks.LIGHT_BLUE_PRESSURE_PLATE.get())
            .fence(PastelBlocks.LIGHT_BLUE_FENCE.get())
            .fenceGate(PastelBlocks.LIGHT_BLUE_FENCE_GATE.get())
    ...
    public static final BlockFamily LIGHT_GRAY_COLORED_PLANKS_FAMILY = PastelModelHelper.registerBlockFamily(
        new BlockFamily.Builder(PastelBlocks.LIGHT_GRAY_PLANKS.get())
            .stairs(PastelBlocks.LIGHT_GRAY_STAIRS.get())
            .pressurePlate(PastelBlocks.LIGHT_GRAY_PRESSURE_PLATE.get())
            .fence(PastelBlocks.LIGHT_GRAY_FENCE.get())
            .fenceGate(PastelBlocks.LIGHT_GRAY_FENCE_GATE.get())
    ...
    public static final BlockFamily MAGENTA_COLORED_PLANKS_FAMILY = PastelModelHelper.registerBlockFamily(
        new BlockFamily.Builder(PastelBlocks.MAGENTA_PLANKS.get())
            .stairs(PastelBlocks.MAGENTA_STAIRS.get())
            .pressurePlate(PastelBlocks.MAGENTA_PRESSURE_PLATE.get())
    ...
    public static final BlockFamily ORANGE_COLORED_PLANKS_FAMILY = PastelModelHelper.registerBlockFamily(
        new BlockFamily.Builder(PastelBlocks.ORANGE_PLANKS.get())
            .stairs(PastelBlocks.ORANGE_STAIRS.get())
            .pressurePlate(PastelBlocks.ORANGE_PRESSURE_PLATE.get())
    ...
    public static final BlockFamily PURPLE_COLORED_PLANKS_FAMILY = PastelModelHelper.registerBlockFamily(
        new BlockFamily.Builder(PastelBlocks.PURPLE_PLANKS.get())
            .stairs(PastelBlocks.PURPLE_STAIRS.get())
            .pressurePlate(PastelBlocks.PURPLE_PRESSURE_PLATE.get())
    ...
    public static final BlockFamily YELLOW_COLORED_PLANKS_FAMILY = PastelModelHelper.registerBlockFamily(
        new BlockFamily.Builder(PastelBlocks.YELLOW_PLANKS.get())
            .stairs(PastelBlocks.YELLOW_STAIRS.get())
            .pressurePlate(PastelBlocks.YELLOW_PRESSURE_PLATE.get())
    ...
    public static final BlockFamily PRESERVATION_STONE_FAMILY = PastelModelHelper.registerBlockFamilyExceptBase(
        new BlockFamily.Builder(PastelBlocks.PRESERVATION_STONE.get())
            .stairs(PastelBlocks.PRESERVATION_STAIRS.get())
