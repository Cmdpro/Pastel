...
public class AzuriteOreBlock extends CloakedOreBlock {
    ...
    public static final MapCodec<AzuriteOreBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance
        .group(
            IntProvider
                .codec(0, 10)
                .fieldOf("experience")
    ...
    public void animateTick(BlockState state, Level world, BlockPos pos, RandomSource random) {
        ...
        if (this.isVisibleTo(Minecraft.getInstance().player)) {
            ...
            world.playSound(
                null, pos, PastelSoundEvents.SOFT_HUM, SoundSource.BLOCKS, 1F, random.nextFloat() * 0.5F + 1F);
        }
    }
