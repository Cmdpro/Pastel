...
public class PedestalBlockEntityRenderer<C extends PedestalBlockEntity> implements BlockEntityRenderer<C> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        modelPartData
            .getChild("circle")
            .addOrReplaceChild(
                "circle2", CubeListBuilder
                    .create()
                    .texOffs(0, 0)
                    .addBox(-32.0F, 0.0F, -29F, 64.0F, 0.0F, 64.0F), PartPose.rotation(0.0F, 0.0F, 0.0F)
            );
        ...
        if (currentRecipe instanceof PedestalRecipe pedestalRecipe) {
            ...
            if (this.cachedRecipeTime + RECIPE_RECALCULATION_TICKS < currentTime ||
                ...
                this.cachedRecipeOutput = pedestalRecipe.assemble(
                    entity.createRecipeInput(), entity
                        .getLevel()
                        .registryAccess()
                );
                this.cachedRecipe = pedestalRecipe;
            ...
            Minecraft
                ...
                .getItemRenderer()
                .renderStatic(
                    this.cachedRecipeOutput, ItemDisplayContext.GROUND, LightTexture.FULL_BRIGHT, overlay, poseStack,
                    vertexConsumerProvider, entity.getLevel(), 0
                );
            poseStack.popPose();
        }
    }
