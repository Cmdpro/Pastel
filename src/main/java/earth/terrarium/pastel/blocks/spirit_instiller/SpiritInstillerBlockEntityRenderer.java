...
public class SpiritInstillerBlockEntityRenderer implements BlockEntityRenderer<SpiritInstillerBlockEntity> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild(
            "pedestal_r1", CubeListBuilder
                .create()
                .texOffs(43, 38)
                .addBox(-7.5F, -1.5F, -7.5F, 15.0F, 3.0F, 15.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, -0.025F, 0.0F, 0.0F, -0.7854F, 0.0F)
        );
        modelPartData.addOrReplaceChild(
            "spectralblossom", CubeListBuilder
                .create()
                .texOffs(58, 24)
                .addBox(-6.5F, -6.5F, 0.0F, 13.0F, 13.0F, 0.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, -25.0F, 0.0F)
        );
        PartDefinition geode = modelPartData.addOrReplaceChild(
            "geode", CubeListBuilder
                .create()
                .texOffs(0, 24)
                .addBox(-14.5F, -14.5F, 0.0F, 29.0F, 29.0F, 0.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, -25.0F, 0.0F)
        );
        PartDefinition calcite = geode.addOrReplaceChild(
            "calcite", CubeListBuilder
                .create()
                .texOffs(0, 56)
        ...
        calcite.addOrReplaceChild(
            "innergeode", CubeListBuilder
                .create()
                .texOffs(50, 56)
                .addBox(-10.5F, -10.5F, 3.0F, 21.0F, 21.0F, 0.0F, new CubeDeformation(0.0F)),
