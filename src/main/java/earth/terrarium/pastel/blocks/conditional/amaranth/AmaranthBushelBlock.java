...
public class AmaranthBushelBlock extends FlowerBlock implements RevelationAware {
    ...
    public static final MapCodec<AmaranthBushelBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance
        .group(
    ...
    public ResourceLocation getCloakAdvancementIdentifier() {
        return PastelAdvancements.Milestones.REVEAL_AMARANTH;
    }
