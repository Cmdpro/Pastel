...
public class ColoredLeavesBlock extends LeavesBlock implements RevelationAware, ColoredTree {
    ...
    public static final MapCodec<ColoredLeavesBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance
        .group(
            propertiesCodec(),
            InkColor.CODEC
                .fieldOf("color")
        ...
        for (int distance = 1; distance < 8; distance++) {
            map.put(
                this
                    ...
                    .setValue(WATERLOGGED, false), Blocks.OAK_LEAVES
                    .defaultBlockState()
                    .setValue(LeavesBlock.DISTANCE, distance)
                    .setValue(LeavesBlock.PERSISTENT, false)
            ...
            map.put(
                this
                    ...
                    .setValue(LeavesBlock.DISTANCE, distance)
                    .setValue(LeavesBlock.PERSISTENT, false)
                    .setValue(WATERLOGGED, true), Blocks.OAK_LEAVES
                    .defaultBlockState()
                    .setValue(LeavesBlock.DISTANCE, distance)
                    .setValue(LeavesBlock.PERSISTENT, false)
