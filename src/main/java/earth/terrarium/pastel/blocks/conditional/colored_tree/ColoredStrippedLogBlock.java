...
public class ColoredStrippedLogBlock extends RotatedPillarBlock implements RevelationAware, ColoredTree {
    ...
    public static final MapCodec<ColoredStrippedLogBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance
        .group(
            propertiesCodec(),
            InkColor.CODEC
                .fieldOf("color")
    ...
    public Map<BlockState, BlockState> getBlockStateCloaks() {
        ...
        for (Direction.Axis axis : RotatedPillarBlock.AXIS.getPossibleValues()) {
            map.put(
                this
                    .defaultBlockState()
                    .setValue(RotatedPillarBlock.AXIS, axis), Blocks.STRIPPED_OAK_LOG
                    .defaultBlockState()
