...
public class PastelTransmission implements SchedulerMap.Callback {
    ...
    public static final Codec<PastelTransmission> CODEC = RecordCodecBuilder.create(i -> i
        .group(
            BlockPos.CODEC
                .listOf()
                .fieldOf("node_positions")
        ...
        if (destinationNode != null) {
            ...
            if (destinationHandler != null) {
                ...
                inserted -= ItemHandlerHelper
                    .insertItemStacked(destinationHandler, stack.copyWithCount((int) amount), false)
                    .getCount();
