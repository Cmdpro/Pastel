...
public class BottomlessBundleItem extends BlockItem implements InventoryInsertionAcceptor, ItemStorage.LimitCallback {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag type) {
        ...
        if (storedAmount == 0) {
            ...
            var powerLevel = context
                ...
                .orElse(0);
            String totalStacks = Support.getShortenedNumberString(storedAmount / (float) variant
                .asItem()
    ...
    private void playInsertSound(Entity entity) {
        entity.playSound(
            SoundEvents.BUNDLE_INSERT, 0.8F, 0.8F + entity
                                                        .level()
                                                        .getRandom()
                                                        .nextFloat() * 0.4F
        );
    ...
    public long updateLimit(
        ...
        return getMaxStoredAmount(PastelCommon
                                      .getRegistryAccess()
                                      .lookup(Registries.ENCHANTMENT)
                                      .flatMap(impl -> impl.get(Enchantments.POWER))
    ...
    public static class BottomlessBundlePlacementDispenserBehavior extends OptionalDispenseItemBehavior {
        ...
        protected ItemStack execute(BlockSource pointer, ItemStack stack) {
            ...
            if (stack.getItem() instanceof BottomlessBundleItem bottomlessBundleItem) {
                ...
                try {
                    this.setSuccess(bottomlessBundleItem
                                        .place(new DirectionalPlaceContext(
                                            pointer.level(), blockPos, direction, stack,
                                            direction2
                                        ))
                                        .consumesAction());
                } catch (Exception e) {
