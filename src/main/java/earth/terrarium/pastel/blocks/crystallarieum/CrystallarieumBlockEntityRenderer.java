...
public class CrystallarieumBlockEntityRenderer<T extends CrystallarieumBlockEntity> implements BlockEntityRenderer<T> {
    ...
    public void render(
        ...
        if (!fluid.isEmpty()) {
            ...
            var glow = LightTexture.pack(
                Math.max(luminance, skylight), crystal
                    .getLevel()
            ...
            FluidRendering.renderFluid(
                vertexConsumers.getBuffer(RenderType.translucent()), matrices
                    .last()
                    .pose(), sprite, glow, overlay, rim, 16 - rim, y, rim, 16 - rim, colors
            );
    ...
    private void renderHalo(
        ...
        var time = crystal.getLevel() != null ? crystal
                                                    .getLevel()
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition active = modelPartData.addOrReplaceChild(
            "active", CubeListBuilder
                .create()
                .texOffs(40, 34)
                .addBox(-5.0F, -3.0F, -5.0F, 10.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, 22.0F, 0.0F)
        );

        PartDefinition inactive = modelPartData.addOrReplaceChild(
            "inactive", CubeListBuilder
                .create()
                .texOffs(80, 34)
                .addBox(-5.0F, -3.0F, -5.0F, 10.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, 22.0F, 0.0F)
        ...
        PartDefinition halo = modelPartData.addOrReplaceChild(
            "halo", CubeListBuilder
                .create()
                .texOffs(77, 48)
                .addBox(-8.5F, 1.0F, -8.5F, 17.0F, 0.0F, 17.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, -9.0F, 0.0F)
        );

        PartDefinition diamond_r1 = halo.addOrReplaceChild(
            "diamond_r1", CubeListBuilder
                .create()
                .texOffs(80, 65)
                .addBox(-7.5F, 0.0F, -7.5F, 15.0F, 0.0F, 15.0F, new CubeDeformation(0.0F)),
