        ...
        switch (upgradeType) {
            case SPEED -> {
                ...
                modelPartData.addOrReplaceChild(
                    "bone", CubeListBuilder
                        .create()
                        .texOffs(0, 0)
                        .addBox(-2.0F, -4.0F, -2.0F, 4.0F, 8.0F, 4.0F), PartPose.offset(0.0F, 0.0F, 0.0F)
                );
                modelPartData.addOrReplaceChild(
                    "basalt", CubeListBuilder
                        .create()
                        .texOffs(20, 2)
                        .mirror()
                        .addBox(-3.0F, -3.0F, -3.0F, 6.0F, 1.0F, 6.0F), PartPose.offset(0.0F, 0.0F, 0.0F)
                );
                modelPartData.addOrReplaceChild(
                    "basalt2", CubeListBuilder
                        .create()
                        .texOffs(20, 3)
                        .mirror()
                        .addBox(-3.0F, 2.0F, -3.0F, 6.0F, 1.0F, 6.0F), PartPose.offset(0.0F, 0.0F, 0.0F)
                );
                modelPartData.addOrReplaceChild(
                    "gemstone_disk", CubeListBuilder
                        .create()
                        .texOffs(0, 16)
                        .mirror()
                        .addBox(-3.0F, -2.0F, -3.0F, 6.0F, 4.0F, 6.0F), PartPose.offset(0.0F, 0.0F, 0.0F)
                );
