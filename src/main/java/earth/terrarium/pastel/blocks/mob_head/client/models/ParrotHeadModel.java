...
public class ParrotHeadModel extends PastelSkullModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition modelPartData2 = modelPartData.addOrReplaceChild(PartNames.HEAD, CubeListBuilder
            .create()
            .texOffs(2, 2)
            .addBox(-1.0F, -3.0F, -1.0F, 2.0F, 3.0F, 2.0F), PartPose.ZERO
        );
        modelPartData2.addOrReplaceChild("head2", CubeListBuilder
            .create()
            .texOffs(10, 0)
            .addBox(-1.0F, -4.0F, -3.0F, 2.0F, 1.0F, 4.0F), PartPose.ZERO
        );
        modelPartData2.addOrReplaceChild("beak1", CubeListBuilder
            .create()
            .texOffs(11, 7)
            .addBox(-0.5F, -3.0F, -2.0F, 1.0F, 2.0F, 1.0F), PartPose.ZERO
        );
        modelPartData2.addOrReplaceChild("beak2", CubeListBuilder
            .create()
            .texOffs(16, 7)
            .addBox(-0.5F, -3.0F, -3.0F, 1.0F, 2.0F, 1.0F), PartPose.offset(0.0F, -0.25F, 0.05F)
        );
        modelPartData2.addOrReplaceChild("feather", CubeListBuilder
                                             .create()
                                             .texOffs(2, 18)
