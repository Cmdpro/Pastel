...
public class HoglinHeadModel extends PastelSkullModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild(
            PartNames.LEFT_HORN, CubeListBuilder
                .create()
                .texOffs(1, 13)
        ...
        head.addOrReplaceChild(
            PartNames.RIGHT_HORN, CubeListBuilder
                .create()
                .texOffs(10, 13)
        ...
        head.addOrReplaceChild(
            PartNames.LEFT_EAR, CubeListBuilder
                .create()
                .texOffs(1, 1)
        ...
        head.addOrReplaceChild(
            PartNames.RIGHT_EAR, CubeListBuilder
                .create()
                .texOffs(1, 6)
