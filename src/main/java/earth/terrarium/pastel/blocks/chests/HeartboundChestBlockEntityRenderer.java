...
public class HeartboundChestBlockEntityRenderer implements BlockEntityRenderer<HeartboundChestBlockEntity> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition cap = modelPartData.addOrReplaceChild(
            "cap", CubeListBuilder
                .create()
                .texOffs(0, 0)
                .addBox(-7.5F, -5.0F, -14.5F, 15.0F, 5.0F, 15.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, 15.0F, 7.0F)
        );

        PartDefinition toplock = cap.addOrReplaceChild(
            "toplock", CubeListBuilder
                .create()
                .texOffs(0, 0)
                .addBox(-1.5F, -2.0F, -0.5F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, -1.0F, -14.5F)
        );

        PartDefinition bb_main = modelPartData.addOrReplaceChild(
            "bb_main", CubeListBuilder
                .create()
                .texOffs(0, 20)
    ...
    public void render(
        ...
        BlockState blockState = bl ? chest.getBlockState() : PastelBlocks.HEARTBOUND_CHEST
            .get()
            .defaultBlockState()
