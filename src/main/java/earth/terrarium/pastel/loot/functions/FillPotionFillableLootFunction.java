...
public class FillPotionFillableLootFunction extends LootItemConditionalFunction {
    ...
    public record InkPoweredPotionTemplate(
        ...
        public static final MapCodec<InkPoweredPotionTemplate> CODEC = RecordCodecBuilder.mapCodec(i -> i
            .group(
                Codec.BOOL
        ...
        public InkPoweredStatusEffectInstance get(LootContext context) {
            Holder<MobEffect> statusEffect = this.statusEffects.get(context
                                                                        .getRandom()
            ...
            InkColor inkColor = this.inkColors.get(context
                                                       .getRandom()
