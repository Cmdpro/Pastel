...
public class FusionShrineRecipe extends GatedStackPastelRecipe<FluidRecipeInput<FluidTank>> {
    ...
    protected void spawnCraftingResultAndXP(
        ...
        double yieldModifier = yieldUpgradesDisabled ? 1.0 : fusionShrineBlockEntity
            .getUpgradeHolder()
            .getEffectiveValue(Upgradeable.UpgradeType.YIELD);
        ...
        MultiblockCrafter.spawnItemStackAsEntitySplitViaMaxCount(
            world, fusionShrineBlockEntity
                .getBlockPos()
                .above(2), stack, resultAmountAfterMod, MultiblockCrafter.RECIPE_STACK_VELOCITY
        );
    ...
    public static class Serializer implements RecipeSerializer<FusionShrineRecipe> {
        ...
        public static final MapCodec<FusionShrineRecipe> CODEC = RecordCodecBuilder.mapCodec(i -> i
            .group(
                Codec.STRING
