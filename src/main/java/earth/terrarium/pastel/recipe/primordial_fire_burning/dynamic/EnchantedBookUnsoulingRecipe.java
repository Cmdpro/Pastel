...
public class EnchantedBookUnsoulingRecipe extends PrimordialFireBurningRecipe {
        ...
        super(
            ...
            Ingredient.of(Ench
                              .addOrUpgradeEnchantment(
                                  lookup, Items.ENCHANTED_BOOK.getDefaultInstance(), Enchantments.SOUL_SPEED, 1, false,
                                  false
                              )
                              .getB()),
            Ench
                .addOrUpgradeEnchantment(
                    lookup, Items.ENCHANTED_BOOK.getDefaultInstance(), Enchantments.SWIFT_SNEAK, 1,
                    false, false
                )
                .getB()
        );
    ...
    public static class Serializer implements RecipeSerializer<EnchantedBookUnsoulingRecipe> {
        ...
        public static final MapCodec<EnchantedBookUnsoulingRecipe> CODEC = RecordCodecBuilder.mapCodec(i -> i
            .group(
