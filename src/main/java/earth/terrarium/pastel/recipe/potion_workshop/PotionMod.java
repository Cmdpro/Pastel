...
public record PotionMod(
    ...
    public static final Codec<PotionMod> CODEC = RecordCodecBuilder.create(i -> i
        .group(
            Codec.INT
                .optionalFieldOf("flat_duration_bonus_ticks", 0)
                .forGetter(PotionMod::flatDurationBonusTicks),
            Codec.FLOAT
                .optionalFieldOf("flat_potency_bonus", 0f)
                .forGetter(PotionMod::flatPotencyBonus),
            Codec.FLOAT
                .optionalFieldOf("duration_multiplier", 1f)
                .forGetter(PotionMod::durationMultiplier),
            Codec.FLOAT
                .optionalFieldOf("potency_multiplier", 1f)
                .forGetter(PotionMod::potencyMultiplier),
            Codec.FLOAT
                .optionalFieldOf("flat_potency_bonus_positive_effects", 0f)
                .forGetter(PotionMod::flatPotencyBonusPositiveEffects),
            Codec.FLOAT
                .optionalFieldOf("flat_potency_bonus_negative_effects", 0f)
                .forGetter(PotionMod::flatPotencyBonusNegativeEffects),
            Codec.INT
                .optionalFieldOf("flat_duration_bonus_ticks_positive_effects", 0)
                .forGetter(PotionMod::flatDurationBonusPositiveEffects),
            Codec.INT
                .optionalFieldOf("flat_duration_bonus_ticks_negative_effects", 0)
                .forGetter(PotionMod::flatDurationBonusNegativeEffects),
            Codec.FLOAT
                .optionalFieldOf("additional_random_positive_effect_count", 0f)
                .forGetter(PotionMod::additionalRandomPositiveEffectCount),
            Codec.FLOAT
                .optionalFieldOf("additional_random_negative_effect_count", 0f)
                .forGetter(PotionMod::additionalRandomNegativeEffectCount),
            Codec.FLOAT
                .optionalFieldOf("chance_to_add_last_effect", 0f)
                .forGetter(PotionMod::chanceToAddLastEffect),
            Codec.FLOAT
                .optionalFieldOf("last_effect_duration_modifier", 1f)
                .forGetter(PotionMod::lastEffectDurationMultiplier),
            Codec.FLOAT
                .optionalFieldOf("last_effect_potency_modifier", 1f)
                .forGetter(PotionMod::lastEffectPotencyMultiplier),
            Codec.FLOAT
                .optionalFieldOf("flat_yield_bonus", 0f)
                .forGetter(PotionMod::yield),
            Codec.INT
                .optionalFieldOf("additional_drink_duration_ticks", 0)
    ...
    public record PotionFlags(
        ...
        private static final Codec<Tuple<PotionRecipeEffect, Float>> ENTRY_CODEC = RecordCodecBuilder.create(i -> i
            .group(
        ...
        public static final MapCodec<PotionFlags> CODEC = RecordCodecBuilder.mapCodec(i -> i
            .group(
                Codec.BOOL
    ...
    public int getColor(RandomSource random) {
        return flags.randomColor ? java.awt.Color
