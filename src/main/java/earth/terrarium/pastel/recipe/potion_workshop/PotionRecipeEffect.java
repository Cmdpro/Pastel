...
public record PotionRecipeEffect(
    ...
    public static MapCodec<PotionRecipeEffect> CODEC = RecordCodecBuilder.mapCodec(i -> i
        .group(
            Codec.BOOL
        ...
        if (potency >= 0 && durationTicks > 0) {
            ...
            return new InkPoweredStatusEffectInstance(
                new MobEffectInstance(
                    statusEffect, durationTicks, (int) potency, !potionMod
                    .flags()
                    .noParticles(), !potionMod
                    .flags()
                    .noParticles()
                ), new InkCost(inkColor(), inkCost()), effectColor, potionMod
                    .flags()
                    .unidentifiable(), potionMod
                    .flags()
                    .incurable()
            );
        } else {
