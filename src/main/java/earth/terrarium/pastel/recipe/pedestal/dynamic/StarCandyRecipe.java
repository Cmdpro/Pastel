...
public class StarCandyRecipe extends ShapedPedestalRecipe {
    ...
    public StarCandyRecipe() {
        super(
            ...
            Map.of(BuiltinGemstoneColor.YELLOW, 1), PastelItems.STAR_CANDY
                .get()
    ...
    public ItemStack assemble(PedestalRecipeInput input, HolderLookup.Provider wrapperLookup) {
        ...
        if (player != null && player
                                  .getRandom()
                                  .nextFloat() < PURPLE_STAR_CANDY_CHANCE + player.getAttributeValue(Attributes.LUCK)) {
            return PastelItems.ENCHANTED_STAR_CANDY
                .get()
                .getDefaultInstance();
        }
