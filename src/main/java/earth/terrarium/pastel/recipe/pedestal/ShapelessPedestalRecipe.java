...
public class ShapelessPedestalRecipe extends PedestalRecipe {
    ...
    public static class Serializer implements RecipeSerializer<ShapelessPedestalRecipe> {
        ...
        public static final MapCodec<ShapelessPedestalRecipe> CODEC = RecordCodecBuilder.mapCodec(i -> i
            .group(
                Codec.STRING
                ...
                PedestalRecipeTier.CODEC
                    .optionalFieldOf("tier", PedestalRecipeTier.BASIC)
