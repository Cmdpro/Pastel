...
public class PrintConfigCommand {
    ...
    private static int execute(CommandSourceStack source) {
        ...
        send(
            source, "Decay tick rates: " + PastelCommon.CONFIG.FadingDecayTickRate + ", " +
        ...
        send(
            source, "Decay pickup ability: " + PastelCommon.CONFIG.CanBottleUpFading + ", " +
                    PastelCommon.CONFIG.CanBottleUpFailing + ", " + PastelCommon.CONFIG.CanBottleUpRuin + ", " +
                    PastelCommon.CONFIG.CanBottleUpForfeiture
        );
        send(
            source, "Decay can destroy block entities: " + PastelCommon.CONFIG.FadingCanDestroyBlockEntities + ", " +
        ...
        send(
            source, "Bedrock Armor Protection: " + PastelCommon.CONFIG.BedrockArmorHelmetProtection + ", " +
        ...
        send(
            source, "Gemstone Armor Protection: " + PastelCommon.CONFIG.GemstoneArmorHelmetProtection + ", " +
        ...
        send(
            source, "Bedrock Armor Effect Amplifiers: " + PastelCommon.CONFIG.GemstoneArmorWeaknessAmplifier + ", " +
