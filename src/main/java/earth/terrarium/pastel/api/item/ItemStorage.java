...
public class ItemStorage {
    ...
    public static final Codec<ItemStorage> CODEC = RecordCodecBuilder.create(i -> i
        .group(
            ItemReference.CODEC
                .fieldOf("reference")
    ...
    public record Component(ItemReference reference, long count) {
        ...
        public static final Codec<Component> CODEC = RecordCodecBuilder.create(i -> i
            .group(
                ItemReference.CODEC
                    .fieldOf("reference")
