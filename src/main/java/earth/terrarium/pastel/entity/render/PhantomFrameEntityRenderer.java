        ...
        if (!isInvisible) {
            ...
            blockRenderManager
                ...
                .renderModel(
                    ...
                    bakedModelManager.getModel(modelIdentifier), 1.0F, 1.0F, 1.0F, light, OverlayTexture.NO_OVERLAY
                );
            poseStack.popPose();
        }
            ...
            if (mapIdComponent != null) {
                ...
                if (mapState != null) {
                    ...
                    Minecraft.getInstance().gameRenderer
                        .getMapRenderer()
                        .render(poseStack, vertexConsumerProvider, mapIdComponent, mapState, true, k);
                }
            } else {
