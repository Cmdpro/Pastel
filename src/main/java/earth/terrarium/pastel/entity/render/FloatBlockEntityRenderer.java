        ...
        if (blockState.getRenderShape() == RenderShape.MODEL) {
            ...
            if (blockState != world.getBlockState(BlockPos.containing(entity.position())) &&
                ...
                blockRenderManager
                    .getModelRenderer()
                    .tesselateBlock(
                        world, blockRenderManager.getBlockModel(blockState), blockState, blockpos, matrices,
                        vertexConsumers.getBuffer(ItemBlockRenderTypes.getMovingBlockRenderType(blockState)), false,
                        random, blockState.getSeed(entity.getOrigin()), OverlayTexture.NO_OVERLAY
                    );
                matrices.popPose();
