...
public class PastelEntityTypes {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<LagoonFishingBobberEntity>> LAGOON_FISHING_BOBBER
        = register(
        "lagoon_fishing_bobber", EntityType.Builder
            .<LagoonFishingBobberEntity>of(LagoonFishingBobberEntity::new, MobCategory.MISC)
            .noSave()
            .noSummon()
            .fireImmune()
            .sized(0.25F, 0.25F)
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MoltenFishingBobberEntity>> MOLTEN_FISHING_BOBBER
        = register(
        "molten_fishing_bobber", EntityType.Builder
            .<MoltenFishingBobberEntity>of(MoltenFishingBobberEntity::new, MobCategory.MISC)
            .noSave()
            .noSummon()
            .fireImmune()
            .sized(0.25F, 0.25F)
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<BedrockFishingBobberEntity>> BEDROCK_FISHING_BOBBER
        = register(
        "bedrock_fishing_bobber", EntityType.Builder
            .<BedrockFishingBobberEntity>of(BedrockFishingBobberEntity::new, MobCategory.MISC)
            .noSave()
            .noSummon()
            .fireImmune()
            .sized(0.25F, 0.25F)
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EggLayingWoolyPigEntity>> EGG_LAYING_WOOLY_PIG
        = register(
        "egg_laying_wooly_pig", EntityType.Builder
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<GlassArrowEntity>> GLASS_ARROW = register(
        "glass_arrow", EntityType.Builder
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<LightShardEntity>> LIGHT_SHARD = register(
        "light_shard", EntityType.Builder
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<LightSpearEntity>> LIGHT_SPEAR = register(
        "light_spear", EntityType.Builder
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<PreservationTurretEntity>> PRESERVATION_TURRET
        = register(
        "preservation_turret", EntityType.Builder
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<KindlingCoughEntity>> KINDLING_COUGH = register(
        "kindling_cough", EntityType.Builder
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ItemProjectileEntity>> ITEM_PROJECTILE = register(
        "item_projectile", EntityType.Builder
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        event.put(
            EGG_LAYING_WOOLY_PIG.get(), EggLayingWoolyPigEntity
                .createEggLayingWoolyPigAttributes()
                .build()
        );
        event.put(
            PRESERVATION_TURRET.get(), PreservationTurretEntity
                .createGuardianTurretAttributes()
                .build()
        );
        event.put(
            LIZARD.get(), LizardEntity
                .createLizardAttributes()
                .build()
        );
        event.put(
            KINDLING.get(), KindlingEntity
                .createKindlingAttributes()
                .build()
        );
        event.put(
            ERASER.get(), EraserEntity
