...
public class AzureDikeData implements DikeShieldData {
    ...
    public static final Codec<AzureDikeData> CODEC = RecordCodecBuilder.create(i -> i
        .group(
            Codec.FLOAT
                .fieldOf("maxProt")
            ...
            Optional
                ...
                .ifPresent(e -> e.setData(
                    ATTACHMENT, new AzureDikeData(
                        payload.maxProt, payload.currentProt, payload.rechargeTicks, payload.rechargeDelayPostTick(),
