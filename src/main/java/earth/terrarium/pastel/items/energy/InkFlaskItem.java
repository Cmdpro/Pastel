...
public class InkFlaskItem extends Item
    implements InkStorageItem<SingleInkStorage>, LoomPatternProvider, ExtendedItemBarProvider {
    ...
    public BarSignature getSignature(@Nullable Player player, @NotNull ItemStack stack, int index) {
        ...
        return new BarSignature(
            1, 13, 14, progress, 1, color.getColorInt(), 2, ExtendedItemBarProvider.DEFAULT_BACKGROUND_COLOR);
    }
}
