...
public class KnowledgeGemItem extends Item implements LoomPatternProvider {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag type) {
        ...
        if (storedExperience == 0) {
            tooltip.add(Component
                            ...
                            .append(Component
                                        .translatable(
                                            "item.pastel.knowledge_gem.tooltip.stored_experience", maxExperience)
    ...
    public boolean changedDisplayTier(int currentStoredExperience, int destinationStoredExperience) {
        return getDisplayTierForExperience(currentStoredExperience) != getDisplayTierForExperience(
            destinationStoredExperience);
    }
