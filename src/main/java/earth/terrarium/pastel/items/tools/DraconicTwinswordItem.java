...
public class DraconicTwinswordItem extends SwordItem
    implements SplittableItem, SlotReservingItem, Preenchanted, ExtendedItemBarProvider, SlotBackgroundEffectProvider {
    ...
    public void playSound(ServerPlayer player) {
        player.playNotifySound(
            PastelSoundEvents.METALLIC_UNSHEATHE, SoundSource.PLAYERS, 0.5F, 0.8F + player
                                                                                        .getRandom()
                                                                                        .nextFloat() * 0.4F
        );
    }
    ...
    public BarSignature getSignature(@Nullable Player player, @NotNull ItemStack stack, int index) {
        ...
        return new BarSignature(
            2, 13, 13, progress, 1, InkColors.YELLOW_COLOR, 2, ExtendedItemBarProvider.DEFAULT_BACKGROUND_COLOR);
    }
