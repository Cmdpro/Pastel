...
public class WorkstaffItem extends MultiToolItem implements AreaMiningHandler, Preenchanted {
    ...
    private static void enchantAndRemoveOthers(
        ...
        var removeResult = PastelEnchantmentHelper.removeEnchantments(
        ...
        if (removeResult.getB() == 0) {
            ...
            var addResult = PastelEnchantmentHelper.addOrUpgradeEnchantment(
            ...
            if (addResult.getA()) {
                stack.set(
                    DataComponents.ENCHANTMENTS, addResult
                        .getB()
                        .getEnchantments()
                );
