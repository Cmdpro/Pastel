...
public class OmniAcceleratorItem extends BundleItem
    implements InkPowered, ExtendedItemBarProvider, SlotBackgroundEffectProvider {
    ...
    public ExtendedItemBarProvider.BarSignature getSignature(
        ...
        return new ExtendedItemBarProvider.BarSignature(
            2, 13, 13, progress, 1, 0xFFFFFFFF, 2, ExtendedItemBarProvider.DEFAULT_BACKGROUND_COLOR);
    }
}
