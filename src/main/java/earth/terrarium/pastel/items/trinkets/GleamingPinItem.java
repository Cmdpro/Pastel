...
public class GleamingPinItem extends PastelTrinketItem {
    ...
    public static void doGleamingPinEffect(
        ...
        world.playSound(
            ...
            SoundSource.PLAYERS, 0.4F, 0.9F + world
                                                  .getRandom()
                                                  .nextFloat() * 0.2F
        );
        PlayParticleWithRandomOffsetAndVelocityPayload.playParticleWithRandomOffsetAndVelocity(
            world, player
                .position()
                .add(0, 0.75, 0), PastelParticleTypes.LIQUID_CRYSTAL_SPARKLE, 100, new Vec3(0, 0.5, 0),
        ...
        world
            .getEntities(
                player, player
                    .getBoundingBox()
                    .inflate(getEffectRange(world, gleamingPinStack)), EntitySelector.LIVING_ENTITY_STILL_ALIVE
            )
            .forEach((entity) -> {
