...
public class PastelModelHelper {
    ...
    public static void registerLayeredItemModel(
        ...
        model.create(
            ModelLocationUtils.getModelLocation(item), TextureMapping
                .layered(
                    TextureMapping.getItemTexture(item, suffix0), TextureMapping.getItemTexture(item, suffix1),
                    TextureMapping.getItemTexture(item, suffix2)
                )
                .put(PastelTextureKeys.LAYER3, TextureMapping.getItemTexture(item, suffix3)), ctx.output
        );
    }
    ...
    public static BlockStateGenerator glassPaneBlockModel(
        ...
        return MultiPartGenerator
            ...
            .with(
                Condition
                    .condition()
                    .term(BlockStateProperties.NORTH, true), Variant
                    .variant()
            ...
            .with(
                Condition
                    .condition()
                    .term(BlockStateProperties.EAST, true), Variant
                    .variant()
                    .with(VariantProperties.MODEL, side)
            ...
            .with(
                Condition
                    .condition()
                    .term(BlockStateProperties.SOUTH, true), Variant
                    .variant()
                    .with(VariantProperties.MODEL, sideAlt)
            )
            .with(
                Condition
                    .condition()
                    .term(BlockStateProperties.WEST, true), Variant
                    .variant()
                    .with(VariantProperties.MODEL, sideAlt)
                    .with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)
            )
            .with(
                Condition
                    .condition()
                    .term(BlockStateProperties.NORTH, false), Variant
                    .variant()
                    .with(VariantProperties.MODEL, noside)
            )
            .with(
                Condition
                    .condition()
                    .term(BlockStateProperties.EAST, false), Variant
                    .variant()
                    .with(VariantProperties.MODEL, nosideAlt)
            )
            .with(
                Condition
                    .condition()
                    .term(BlockStateProperties.SOUTH, false), Variant
                    .variant()
                    .with(VariantProperties.MODEL, nosideAlt)
                    .with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)
            )
            .with(
                Condition
                    .condition()
                    .term(BlockStateProperties.WEST, false), Variant
                    .variant()
                    .with(VariantProperties.MODEL, noside)
    ...
    public static BlockFamily registerBlockFamily(BlockFamily family) {
        BLOCK_STATE_MODEL_REGISTRAR.defer(ctx -> ctx
    ...
    public static PropertyDispatch createAxisRotatedVariantMap(
        ...
        return PropertyDispatch
            .property(BlockStateProperties.AXIS)
            .select(
                Direction.Axis.X, createModelVariant(horizontalModelId)
                    .with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)
                    .with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)
            )
            ...
            .select(
                Direction.Axis.Z,
                createModelVariant(horizontalModelId).with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)
            );
    }
    ...
    public static PropertyDispatch createDownDefaultFacingVariantMap(
        ...
        return PropertyDispatch
            ...
            .select(
                Direction.UP,
                createModelVariant(verticalModelId).with(VariantProperties.X_ROT, VariantProperties.Rotation.R180)
            )
            .select(
                Direction.NORTH,
                createModelVariant(horizontalModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)
            )
            .select(
                Direction.SOUTH,
                createModelVariant(horizontalModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)
            )
            .select(
                Direction.WEST,
                createModelVariant(horizontalModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)
            )
    ...
    public static PropertyDispatch createUpNorthDefaultOrientationVariantMap() {
        return PropertyDispatch
            ...
            .select(
                FrontAndTop.DOWN_NORTH, Variant
                    .variant()
                    .with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)
            )
            .select(
                FrontAndTop.DOWN_SOUTH, Variant
                    .variant()
                    .with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)
                    .with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)
            )
            .select(
                FrontAndTop.DOWN_WEST, Variant
                    .variant()
                    .with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)
                    .with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)
            )
            .select(
                FrontAndTop.DOWN_EAST, Variant
                    .variant()
                    .with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)
                    .with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)
            )
            .select(
                FrontAndTop.UP_NORTH, Variant
                    .variant()
                    .with(VariantProperties.X_ROT, VariantProperties.Rotation.R270)
                    .with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)
            )
            .select(
                FrontAndTop.UP_SOUTH, Variant
                    .variant()
                    .with(VariantProperties.X_ROT, VariantProperties.Rotation.R270)
            )
            .select(
                FrontAndTop.UP_WEST, Variant
                    .variant()
                    .with(VariantProperties.X_ROT, VariantProperties.Rotation.R270)
                    .with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)
            )
            .select(
                FrontAndTop.UP_EAST, Variant
                    .variant()
                    .with(VariantProperties.X_ROT, VariantProperties.Rotation.R270)
                    .with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)
            )
