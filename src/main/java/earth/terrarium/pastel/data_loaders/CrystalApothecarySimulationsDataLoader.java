...
public class CrystalApothecarySimulationsDataLoader extends SimpleJsonResourceReloadListener {
    ...
    public record SimulatedBlockGrowthEntry(
        ...
        public static final Codec<SimulatedBlockGrowthEntry> CODEC = RecordCodecBuilder.create(i -> i
            .group(
                BuiltInRegistries.BLOCK
                    .byNameCodec()
                    .listOf()
                    .xmap(
                        list -> (Collection<Block>) list, set -> set
                            .stream()
                            .toList()
                    )
    ...
    protected void apply(
        ...
        prepared.forEach((identifier, jsonElement) -> {
            ...
            if (entry
                    ...
                    .result()
                    .isEmpty()) {
                PastelCommon.logError("Crystal Apothecary Simulation error for " + identifier + ": " + entry
                    .error()
            ...
            DataResult<Block> buddingBlock = BuiltInRegistries.BLOCK
                .byNameCodec()
                .decode(JsonOps.INSTANCE, object.get("budding_block"))
                .map(Pair::getFirst);
            if (buddingBlock
                    .error()
                    ...
                    .result()
                    .isEmpty()) {
                PastelCommon.logError("Crystal apothecary simulation error for " + identifier + ": " + buddingBlock
                    .error()
                    .get() + ". Ignoring that one.");
                return;
            }
