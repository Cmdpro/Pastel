...
public class BookTitrationBarrelFermentingPageRenderer
    ...
    public BookTitrationBarrelFermentingPageRenderer(BookGatedRecipePage<TitrationBarrelRecipe> page) {
        ...
        ResourceLocation font = BookDataManager.Client
            ...
            .safeFont(this.page
                          .getBook()
                          .getFont());
        durationText1 = recipe1 == null ? null : new BookTextHolder(TitrationBarrelRecipe
                                                                        .getDurationText(
                                                                            recipe1
                                                                                .value()
                                                                                .getMinFermentationTimeHours(), recipe1
                                                                                .value()
                                                                                .getFermentationData()
                                                                        )
                                                                        .withStyle(s -> s.withFont(font)));
        durationText2 = recipe2 == null ? null : new BookTextHolder(TitrationBarrelRecipe
                                                                        .getDurationText(
                                                                            recipe2
                                                                                .value()
                                                                                .getMinFermentationTimeHours(), recipe2
                                                                                .value()
                                                                                .getFermentationData()
                                                                        )
                                                                        .withStyle(s -> s.withFont(font)));
    ...
    protected void drawRecipe(
        ...
        if (recipe.getTappingItem() == Items.AIR) {
            ...
            parentScreen.renderItemStack(
                drawContext, recipeX + 60, recipeY + 20, mouseX, mouseY, recipe
                    .getTappingItem()
                    .getDefaultInstance()
            );
        }
