...
public class BookCrystallarieumGrowingPageRenderer
    ...
    public BookCrystallarieumGrowingPageRenderer(BookGatedRecipePage<CrystallarieumRecipe> page) {
        ...
        if (page.getRecipe1() != null) {
            craftingTimeText1 = new BookTextHolder(Component
                                                       .translatable(
                                                           ...
                                                           : "container.pastel.rei.crystallarieum" +
                                                             ".crafting_time_per_stage_seconds",
                                                           page
                                                               .getRecipe1()
                                                               .value()
        ...
        if (page.getRecipe2() != null) {
            craftingTimeText2 = new BookTextHolder(Component
                                                       .translatable(
                                                           page
                                                               .getRecipe2()
                                                               .value()
    ...
    protected void drawRecipe(
        ...
        parentScreen.renderItemStack(
            drawContext, recipeX + startX + offsetPerReagent, recipeY - 1, mouseX, mouseY, growthState
                .getBlock()
                .asItem()
                .getDefaultInstance()
        );
        ...
        while (it.hasNext()) {
            parentScreen.renderItemStack(
                drawContext, recipeX + 62 + offsetPerReagent * x, recipeY + 4, mouseX, mouseY, it
                    .next()
                    .getBlock()
                    .asItem()
                    .getDefaultInstance()
