...
public class CrystallarieumDisplay extends PastelDisplay {
    ...
    public CrystallarieumDisplay(@NotNull RecipeHolder<CrystallarieumRecipe> recipe) {
        ...
        for (BlockState state : recipe
            .value()
            .getGrowthStages()) {
            growthStages.add(EntryIngredients.of(state
                                                     .getBlock()
                                                     .asItem()));
        }
        this.catalysts = recipe
            .value()
            .getCatalysts();
        this.inkColor = recipe
            .value()
            .getInkColor();
        this.growsWithoutCatalyst = recipe
            .value()
            .growsWithoutCatalyst();
        this.secondsPerStage = recipe
            .value()
    ...
    public static List<EntryIngredient> inputs(CrystallarieumRecipe recipe) {
        ...
        Item firstBlockStateItem = recipe
            .getGrowthStages()
            .get(0)
            .getBlock()
            .asItem();
    ...
    public static List<EntryIngredient> outputs(CrystallarieumRecipe recipe) {
        ...
        for (BlockState growthStageState : recipe.getGrowthStages()) {
            Item blockStateItem = growthStageState
                .getBlock()
                .asItem();
