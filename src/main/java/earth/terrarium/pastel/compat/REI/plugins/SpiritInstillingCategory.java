...
public class SpiritInstillingCategory extends GatedDisplayCategory<SpiritInstillingDisplay> {
    ...
    public void setupWidgets(
        ...
        widgets.add(Widgets
                        ...
                        .markInput()
                        .entries(inputs.get(SpiritInstillerRecipe.FIRST_INGREDIENT)));
        widgets.add(Widgets
                        .createSlot(new Point(startPoint.x + startX + 20, startPoint.y + 1))
                        .markInput()
                        .entries(inputs.get(SpiritInstillerRecipe.CENTER_INGREDIENT)));
        widgets.add(Widgets
                        .createSlot(new Point(startPoint.x + startX + 40, startPoint.y + 1))
                        .markInput()
                        .entries(inputs.get(SpiritInstillerRecipe.SECOND_INGREDIENT)));
