...
public class TravelersBackpackCompat extends PastelIntegrationPacks.ModIntegrationPack {
    ...
    public void register() {
        EffectFluidRegistry.registerFluidEffect(new PastelEffectFluid(
            "pastel:humus", PastelFluids.HUMUS
            .get()
            .getSource()
        ) {
            @Override
        ...
        EffectFluidRegistry.registerFluidEffect(new PastelEffectFluid(
            "pastel:liquid_crystal", PastelFluids.LIQUID_CRYSTAL
            .get()
            .getSource()
        ) {
            @Override
        ...
        EffectFluidRegistry.registerFluidEffect(new PastelEffectFluid(
            "pastel:midnight_solution", PastelFluids.MIDNIGHT_SOLUTION
            .get()
            .getSource()
        ) {
            @Override
        ...
        EffectFluidRegistry.registerFluidEffect(new PastelEffectFluid(
            "pastel:dragonrot", PastelFluids.DRAGONROT
            .get()
            .getSource()
        ) {
            @Override
