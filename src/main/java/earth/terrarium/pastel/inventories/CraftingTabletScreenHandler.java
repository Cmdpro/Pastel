    ...
    protected void updateResult(
        ...
        if (!world.isClientSide) {
            ...
            if (optionalPedestalCraftingRecipe.isPresent()) {
                ...
                PedestalRecipe pedestalRecipe = optionalPedestalCraftingRecipe
                    .get()
                    .value();
                ItemStack itemStack = pedestalRecipe
    ...
    public void removed(Player playerEntity) {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (!itemStack.isEmpty()) {
                boolean insertInventorySuccess = playerEntity
                    .getInventory()
                    .add(itemStack);
                ...
                if (insertInventorySuccess && itemStack.isEmpty()) {
                    ...
                    playerEntity
                        ...
                        .playSound(
                            ...
                            SoundEvents.ITEM_PICKUP, SoundSource.PLAYERS, 0.2F, ((playerEntity
                                                                                      .getRandom()
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot.hasItem()) {
            ...
            if (index == 14) {
                ...
                this.context.execute((world, pos) -> clickedSlotStack
                    .getItem()
