...
public class ParticleSpawnerScreen extends AbstractContainerScreen<ParticleSpawnerScreenHandler> {
    ...
    protected void renderBg(GuiGraphics drawContext, float delta, int mouseX, int mouseY) {
        ...
        for (int j = 0; j < PARTICLES_PER_PAGE; j++) {
            ...
            TextureAtlasSprite particleSprite = spriteAtlasTexture.getSprite(displayedParticleEntries
                                                                                 .get(spriteIndex)
                                                                                 .textureIdentifier());
    ...
    protected void setupInputFields(ParticleSpawnerBlockEntity blockEntity) {
        ...
        cyanField = addTextFieldWidget(
            startX + 16, startY + 51, Component.literal("Cyan"), String.valueOf(configuration
                                                                                    .cmyColor()
                                                                                    .getX()),
            this::isPositiveDecimalNumber100
        );
        magentaField = addTextFieldWidget(
            startX + 57, startY + 51, Component.literal("Magenta"), String.valueOf(configuration
                                                                                       .cmyColor()
                                                                                       .getY()),
            this::isPositiveDecimalNumber100
        );
        yellowField = addTextFieldWidget(
            startX + 97, startY + 51, Component.literal("Yellow"), String.valueOf(configuration
                                                                                      .cmyColor()
                                                                                      .getZ()),
            this::isPositiveDecimalNumber100
        );
        ...
        collisionsButton = Button
            .builder(Component.translatable("gui.pastel.button.collisions"), this::collisionButtonPressed)
        ...
        forwardButton = Button
            .builder(Component.translatable("gui.pastel.button.forward"), this::navigationButtonPressed)
            .size(12, 14)
    ...
    private @NotNull Button addParticleButton(int x, int y) {
        Button button = Button
            .builder(Component.translatable("gui.pastel.button.particles"), this::particleButtonPressed)
            .size(20, 20)
            .pos(x, y)
            .build();
        addWidget(button);
