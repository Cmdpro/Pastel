...
public class BedrockAnvilScreen extends ItemCombinerScreen<BedrockAnvilScreenHandler> {
    ...
    protected void subInit() {
        ...
        this.nameField.setEditable((this.menu)
                                       .getSlot(0)
                                       .hasItem());
        ...
        this.loreField.setEditable((this.menu)
                                       .getSlot(0)
                                       .hasItem());
    ...
    private void onRenamed(String name) {
        ...
        if (slot.hasItem()) {
            ...
            if (!slot
                .getItem()
                .has(DataComponents.CUSTOM_NAME) && string.equals(slot
                                                                      .getItem()
                                                                      .getHoverName()
                                                                      .getString())) {
                string = "";
    ...
    public void slotChanged(AbstractContainerMenu handler, int slotId, ItemStack stack) {
        ...
        if (slotId == 0) {
            ...
            this.nameField.setValue(stack.isEmpty() ? "" : stack
                .getHoverName()
                .getString());
            if (!(this.menu
                      .getSlot(1)
                ...
                if (stack.getHoverName() instanceof MutableComponent mutableText) {
                    if (mutableText
                        ...
                        this.nameField.setTextColor(mutableText
                                                        .getStyle()
                                                        .getColor()
                                                        .getValue());
                    }
        ...
        if (slotId == 1) {
            if (stack.getItem() instanceof PigmentItem pigmentItem) {
                this.nameField.setTextColor(pigmentItem
                                                .getInkColor()
                                                .getColorInt());
            } else {
                if (this.menu
