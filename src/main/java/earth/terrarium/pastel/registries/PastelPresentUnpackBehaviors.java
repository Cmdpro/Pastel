...
public class PastelPresentUnpackBehaviors {
    ...
    public static void register() {
        PresentBlock.registerBehavior(
            PastelItems.PIPE_BOMB.get(), (stack, presentBlockEntity, world, pos, random) -> {
        ...
        PresentBlock.registerBehavior(
            PastelItems.STORM_STONE.get(), (stack, presentBlockEntity, world, pos, random) -> {
        ...
        PresentBlock.registerBehavior(
            PastelBlocks.INCANDESCENT_AMALGAM.get(), (stack, presentBlockEntity, world, pos, random) -> {
        ...
        PresentBlock.registerBehavior(
            Items.FIREWORK_ROCKET, (stack, presentBlockEntity, world, pos, random) -> {
        ...
        PresentBlock.registerBehavior(
            Items.GOAT_HORN, (stack, presentBlockEntity, world, pos, random) -> {
        ...
        PresentBlock.registerBehavior(
            Items.BELL, (stack, presentBlockEntity, world, pos, random) -> {
        ...
        PresentBlock.registerBehavior(
            Items.TNT, (stack, presentBlockEntity, world, pos, random) -> {
                if (stack.getCount() > 0) {
        ...
        PresentBlock.registerBehavior(
            Items.EXPERIENCE_BOTTLE, (stack, presentBlockEntity, world, pos, random) -> {
                int totalXP = 0;
                for (int i = 0; i < stack.getCount(); i++) {
        ...
        PresentBlock.registerBehavior(
            Items.EGG, (stack, presentBlockEntity, world, pos, random) -> {
                int chickenCount
        ...
        PresentBlock.registerBehavior(
            PastelBlocks.MEMORY.get(), (stack, presentBlockEntity, world, pos, random) -> {
