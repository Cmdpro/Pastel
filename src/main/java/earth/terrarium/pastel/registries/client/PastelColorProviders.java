...
public class PastelColorProviders {
    ...
    private static final ItemColor THAT_ONE_VANILLA_ITEM_PROVIDER = (stack, tint) -> {
        BlockState blockstate = ((BlockItem) stack.getItem())
            .getBlock()
            .defaultBlockState();
        ...
        event.register(
            (stack, tintIndex) -> {
                if (tintIndex == 1) {
                    ...
                    return FastColor.ARGB32.opaque(storage
                                                       .getStoredColor()
                                                       .getColorInt());
                }
                return -1;
        ...
        event.register(
            (stack, tintIndex) -> {
                if (tintIndex == 1) {
                    ...
                    if (!effects.isEmpty()) {
                        return FastColor.ARGB32.opaque(effects
                                                           .getFirst()
                                                           .getColor());
                    }
                }
    ...
    public static void registerBrewColors(RegisterColorHandlersEvent.Item event, Item brew) {
        event.register(
            (stack, tintIndex) -> {
                ...
                return FastColor.ARGB32.opaque(stack
                                                   .getOrDefault(
