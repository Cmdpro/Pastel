...
public class PastelTexturedModels {
    ...
    public static final TexturedModel.Provider BOWL = TexturedModel.createDefault(
        b -> new TextureMapping()
            ...
            .put(TOP, getBlockTexture(b, "_top"))
            .put(BOTTOM, getBlockTexture(b, "_bottom"))
            .put(INNER, getBlockTexture(b, "_inner")), PastelModels.BOWL
    );
    ...
    public static TexturedModel.Provider baseTransLantern(boolean diagonal, boolean tall) {
        return TexturedModel.createDefault(
            b -> new TextureMapping()
                ...
                .put(CASE, getBlockTexture(b, "_case_on")), PastelModels.baseTransLantern(diagonal, tall)
        );
    }
    ...
    public static TexturedModel.Provider complexOrientable(
        ...
        return TexturedModel.createDefault(
            b -> new TextureMapping()
                .put(SIDE, getBlockTexture(sideBlock.apply(b), sideSuffix))
                .put(TOP, getBlockTexture(topBlock.apply(b), topSuffix))
                .put(BOTTOM, getBlockTexture(bottomBlock.apply(b), bottomSuffix))
                .put(FRONT, getBlockTexture(frontBlock.apply(b), frontSuffix))
                .put(BACK, getBlockTexture(backBlock.apply(b), backSuffix))
                .put(PARTICLE, getBlockTexture(particleBlock.apply(b), particleSuffix)), PastelModels.COMPLEX_ORIENTABLE
        );
    }
