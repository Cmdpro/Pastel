...
public class PastelModelPredicateProviders {
    ...
    public static void registerClient(FMLClientSetupEvent event) {
        ...
        registerBottomlessBundlePredicates(PastelBlocks.BOTTOMLESS_BUNDLE
                                               .get()
                                               .asItem());
        registerEnchantmentCanvasPredicates(PastelItems.ENCHANTMENT_CANVAS.get());
        registerPresentPredicates(PastelBlocks.PRESENT
                                      .get()
                                      .asItem());
    ...
    private static void registerKnowledgeDropPredicates(Item item) {
        ItemProperties.register(
            item, ResourceLocation.parse("stored_experience_10000"), (stack, world, entity, i) -> {
                if (world == null)
                    return 0F;
