...
public class PastelItemGroups {
    ...
    public static final CreativeModeTab TOOLS = CreativeModeTab
        ...
        .displayItems((displayContext, entries) -> {
            ...
            entries.accept(
                Preenchanted.getDefaultEnchantedStack(lookup, PastelItems.GLASS_CREST_ULTRA_GREATSWORD.get()));
            entries.accept(
                Preenchanted.getDefaultEnchantedStack(lookup, PastelItems.FEROCIOUS_GLASS_CREST_BIDENT.get()));
            ...
            entries.accept(
                Ench.getEnchantedStack(lookup, PastelItems.SEVEN_LEAGUE_BOOTS.get(), Map.of(Enchantments.POWER, 5)));
            ...
            entries.accept(Ench.getEnchantedStack(
                lookup, PastelItems.TAKE_OFF_BELT.get(),
                Map.of(Enchantments.POWER, 5, Enchantments.FEATHER_FALLING, 4)
            ));
            ...
            entries.accept(PastelItems.SHIELDGRASP_AMULET
                               .get()
                               .getFullStack());
            entries.accept(PastelItems.HEARTSINGERS_REWARD.get());
            entries.accept(PastelItems.HEARTSINGERS_REWARD
                               .get()
                               .getFullStack());
            entries.accept(PastelItems.GLOVES_OF_DAWNS_GRASP.get());
            entries.accept(PastelItems.GLOVES_OF_DAWNS_GRASP
                               .get()
                               .getFullStack());
            entries.accept(PastelItems.RING_OF_PURSUIT.get());
            entries.accept(PastelItems.RING_OF_PURSUIT
                               .get()
                               .getFullStack());
            entries.accept(PastelItems.RING_OF_DENSER_STEPS.get());
            entries.accept(PastelItems.RING_OF_DENSER_STEPS
                               .get()
                               .getFullStack());
            entries.accept(PastelItems.RING_OF_AERIAL_GRACE.get());
            entries.accept(PastelItems.RING_OF_AERIAL_GRACE
                               .get()
                               .getFullStack());
            entries.accept(PastelItems.LAURELS_OF_SERENITY.get());
            entries.accept(PastelItems.LAURELS_OF_SERENITY
                               .get()
                               .getFullStack());
            entries.accept(PastelItems.GLEAMING_PIN.get());
            entries.accept(
                Ench.getEnchantedStack(lookup, PastelItems.GLEAMING_PIN.get(), Map.of(PastelEnchantments.SNIPING, 2)));
            ...
            entries.accept(Ench.getEnchantedStack(
                lookup, PastelBlocks.BOTTOMLESS_BUNDLE
                    .get()
                    .asItem(), Map.of(Enchantments.POWER, 5, PastelEnchantments.VOIDING, 1)
            ));

            entries.accept(PastelItems.KNOWLEDGE_GEM.get());
            ItemStack enchantedKnowledgeGemStack = Ench.getEnchantedStack(
                lookup, PastelItems.KNOWLEDGE_GEM
                    .get()
                    .asItem(), Map.of(Enchantments.EFFICIENCY, 5, Enchantments.QUICK_CHARGE, 3)
            );
            ...
            entries.accept(
                Ench.getEnchantedStack(lookup, PastelItems.NATURES_STAFF.get(), Map.of(Enchantments.EFFICIENCY, 5)));
            ...
            Ench
                .addOrUpgradeEnchantmentOpt(
                    lookup, PastelItems.EXCHANGING_STAFF
                        .get()
                        .getDefaultInstance(), Enchantments.FORTUNE, 3, false, false
                )
            ...
            Ench
                .addOrUpgradeEnchantmentOpt(
                    lookup, PastelItems.EXCHANGING_STAFF
                        .get()
                        .getDefaultInstance(), Enchantments.SILK_TOUCH, 1, false, false
                )
                .ifPresent(entries::accept);
            Ench
                .addOrUpgradeEnchantmentOpt(
                    lookup, PastelItems.EXCHANGING_STAFF
                        .get()
                        .getDefaultInstance(), PastelEnchantments.RESONANCE, 1, false, false
                )
                .ifPresent(entries::accept);
            ...
            for (InkColor color : InkColors.all()) {
                entries.accept(PastelItems.INK_FLASK
                                   .get()
                                   .getFullStack(color));
            }
            entries.accept(PastelItems.INK_ASSORTMENT.get());
            entries.accept(PastelItems.INK_ASSORTMENT
                               .get()
                               .getFullStack());
            entries.accept(PastelItems.PIGMENT_PALETTE.get());
            entries.accept(PastelItems.PIGMENT_PALETTE
                               .get()
                               .getFullStack());
            entries.accept(PastelItems.ARTISTS_PALETTE.get());
            entries.accept(PastelItems.ARTISTS_PALETTE
                               .get()
                               .getFullStack());
    ...
    public static final CreativeModeTab CUISINE = CreativeModeTab
        ...
        .displayItems((displayContext, entries) -> {
            ...
            if (PastelCommon.getSidedServer() != null) {
                for (RecipeHolder<ITitrationBarrelRecipe> recipe : PastelCommon
                    .getSidedServer()
                    .getRecipeManager()
                    .getAllRecipesFor(PastelRecipeTypes.TITRATION_BARREL)) {
                    ItemStack output = recipe
                        .value()
                        .getResultItem(PastelCommon.getRegistryAccess())
                        .copy();
                    if (output
                        .getItem()
                        .components()
                        .has(PastelDataComponentTypes.INFUSED_BEVERAGE)) {
                        output.setCount(1);
    ...
    public static final CreativeModeTab RESOURCES = CreativeModeTab
        ...
        .displayItems((displayContext, entries) -> {
            ...
            entries.accept(PastelItems.MIDNIGHT_ABERRATION
                               .get()
                               .getStableStack());
    ...
    public static final CreativeModeTab HEADS = CreativeModeTab
        .builder()
        .icon(() -> PastelSkullBlock.MOB_HEADS
            .get(PastelSkullType.EGG_LAYING_WOOLY_PIG)
            .asItem()
            .getDefaultInstance())
